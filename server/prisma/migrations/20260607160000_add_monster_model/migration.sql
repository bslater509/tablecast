...
INSERT INTO "new_tokens" ("characterId", "createdAt", "id", "imageUrl", "label", "mapId", "npcId", "stats", "updatedAt", "x", "y") SELECT "characterId", "createdAt", "id", "imageUrl", "label", "mapId", "npcId", "stats", "updatedAt", "x", "y" FROM "tokens";
DROP TABLE "tokens";
